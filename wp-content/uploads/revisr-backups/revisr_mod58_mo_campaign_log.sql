...
DROP TABLE IF EXISTS `mod58_mo_campaign_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mod58_mo_campaign_log` (
...
LOCK TABLES `mod58_mo_campaign_log` WRITE;
/*!40000 ALTER TABLE `mod58_mo_campaign_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `mod58_mo_campaign_log` ENABLE KEYS */;
UNLOCK TABLES;
